...
export default function App() {
  ...
  const handleAnalyze = async (file: File, conditions: string) => {
    ...
    try {
      ...
      toast.loading('Analyzing... This may take a moment if the server is waking up.', { id: 'analyzing' });
      ...
      if (error instanceof TypeError && error.message.includes('Failed to fetch')) {
        toast.error('Network error: Unable to reach server. Try enabling Demo Mode below.', { duration: 5000 });
      } else {
